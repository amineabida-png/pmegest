...
try { db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS employes (
    ...
    cin TEXT DEFAULT '', cnss_num TEXT DEFAULT '',
    date_naissance TEXT DEFAULT '', date_embauche TEXT NOT NULL,
    type_contrat TEXT DEFAULT 'CDI', poste TEXT DEFAULT '',
    departement TEXT DEFAULT '', salaire_base REAL DEFAULT 0,
    indemnite_transport REAL DEFAULT 0, indemnite_repas REAL DEFAULT 0,
  ...
  CREATE TABLE IF NOT EXISTS bulletins (
    ...
    statut TEXT DEFAULT 'brouillon', created_at TEXT DEFAULT (datetime('now')),
    FOREIGN KEY (account_id) REFERENCES accounts(id),
